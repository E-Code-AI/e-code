...
export default function Marketplace() {
  ...
  const extensions = [
    ...
    },
    {
      ...
      description: 'Automatically format your code for better readability',
      author: 'Prettier',
      downloads: 1924873,
      rating: 4.9,
      reviews: 8932,
    ...
    },
    {
      id: 3,
      name: 'Dark+ Theme',
      description: 'Modern dark theme with syntax highlighting',
      author: 'VS Code Team',
      downloads: 3521847,
      rating: 4.7,
      reviews: 12847,
    ...
    },
    {
      ...
      featured: false,
      installed: false,
      tags: ['Development', 'Server', 'Live Reload']
    },
    {
      id: 5,
      name: 'React Snippets Pro',
      description: 'Advanced React code snippets and templates',
      author: 'ReactDev Studio',
      downloads: 456789,
      rating: 4.9,
      reviews: 2145,
      category: 'Snippets',
