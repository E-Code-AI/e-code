...
export const MODEL_PRICING: Record<string, ModelPricingEntry> = {
  ...
  'claude-haiku-4-5-20251001':  { input: 0.8,   output: 4.0,   provider: 'anthropic', name: 'Claude Haiku 4.5' },
  'claude-3-7-sonnet-20250219': { input: 3.0,   output: 15.0,  provider: 'anthropic', name: 'Claude 3.7 Sonnet' },
  'claude-sonnet-4-6': { input: 3.0,   output: 15.0,  provider: 'anthropic', name: 'Claude 3.5 Sonnet' },
  'claude-haiku-4-5-20251001':  { input: 0.8,   output: 4.0,   provider: 'anthropic', name: 'Claude 3.5 Haiku' },
