import{b0 as ne,r as l,bj as F,F as re,H as oe,cb as E,G as ce,j as e,c as v,a4 as U,al as V,B as n,c5 as k,c6 as O,c7 as R,R as de,L as me,aE as pe,at as he,au as xe,a0 as p,a1 as P,a_ as y,bm as ue,am as fe,dn as ge}from"./index-RrcCeXyQ.js";import{S as _}from"./slider-B-c8GVFE.js";import{S as ve}from"./switch-D2XU-3j1.js";import{S as z}from"./smartphone-cCzRfKP3.js";import{T as ye}from"./tablet-vdrR_Ymi.js";import{M as H,A as we,e as je,f as Ne}from"./ReplitAgentPanelV3-DKMd0Are.js";import{a as be,Z as Se}from"./zoom-out-CldsClbU.js";import{U as Ce,R as Ee}from"./undo-2-B1DGCR7A.js";import{T as ke}from"./type-CVm3_lzO.js";import{B as Oe}from"./bold-Dd3RWici.js";import{I as Re}from"./italic-DqfYPpbr.js";import{S as Pe}from"./save-DMM6GX9D.js";import"./index-Cey_T68c.js";import"./textarea-D21miZFj.js";import"./card-DSW0lr9A.js";import"./brain-CuHZkdEq.js";import"./circle-check-big-DEcnU1dL.js";import"./AIModelSelector-sCL4og1G.js";import"./select-BUBHFFil.js";import"./chevron-up-C77pHcob.js";import"./skeleton-CkSEPdfC.js";import"./index-Cdpk6SHr.js";import"./cpu-Cor77Fmt.js";import"./lightbulb-BZTV0QSc.js";import"./LazyAgGrid-DO1M6x6m.js";import"./table-CACjEa_f.js";import"./chevron-left-DH2H0iJd.js";import"./activity-Cn4X5ql6.js";import"./minimize-2-BGIGkMzd.js";import"./maximize-2-Cgtf6bf7.js";import"./table-2-BYak2QL7.js";import"./pause-CRC9jfSR.js";import"./test-tube-BA_jerUv.js";import"./rotate-ccw-CBi1qc9H.js";import"./circle-x-Cj-uR-8a.js";import"./video-cDClzgZX.js";import"./circle-play-6HkqFAct.js";import"./external-link-CM44Fjgi.js";import"./volume-x-CNMkXlUo.js";import"./volume-2-DmVsO9xW.js";import"./link-2-B1gG-2OM.js";import"./target-C7MeiGPI.js";import"./filter-Ch8AQDfT.js";import"./command-DxnSO4h0.js";import"./file-plus-BEpvYBFE.js";import"./timer-Dp1-i_H0.js";import"./minus-BViXtiwe.js";import"./square-pen-Ch5BoEuL.js";import"./LightSyntaxHighlighter-C3dq6Ujz.js";import"./index-C5LiztgJ.js";import"./use-reduced-motion-DuBhulPs.js";import"./wand-sparkles-BPFa4P6A.js";import"./alert-dialog-C8EU0yJ7.js";import"./mic-B1ONO88Y.js";import"./send-BnDsynxF.js";const D=[{name:"Mobile S",width:320,height:568,icon:z},{name:"Mobile M",width:375,height:667,icon:z},{name:"Mobile L",width:425,height:812,icon:z},{name:"Tablet",width:768,height:1024,icon:ye},{name:"Laptop",width:1024,height:768,icon:F},{name:"Desktop",width:1440,height:900,icon:F}],$=["#000000","#1f2937","#374151","#6b7280","#9ca3af","#d1d5db","#ef4444","#f97316","#f59e0b","#eab308","#84cc16","#22c55e","#14b8a6","#06b6d4","#0ea5e9","#3b82f6","#6366f1","#8b5cf6","#a855f7","#d946ef","#ec4899","#f43f5e","#ffffff","transparent"];function zt({projectId:g,onCodeChange:w,className:q}){ne();const x=l.useRef(null),M=l.useRef(!1),[c,Z]=l.useState(!1),[a,j]=l.useState(null),[N,G]=l.useState(null),[r,b]=l.useState({}),[u,T]=l.useState(""),[m,X]=l.useState(D[5]),[f,A]=l.useState(100),[S,Q]=l.useState(!0),[Y,J]=l.useState([]),[K,ee]=l.useState([]),{data:d,isLoading:te,refetch:C}=re({queryKey:["/api/preview/url",g],queryFn:async()=>{const t=await fetch(`/api/preview/url?projectId=${g}`,{credentials:"include"});if(!t.ok)throw new Error("Failed to get preview status");return t.json()},enabled:!!g,refetchInterval:t=>{const s=t.state.data;return s?.status==="starting"?2e3:s?.status==="running"?1e4:!1}}),L=oe({mutationFn:async()=>ce("POST",`/api/preview/projects/${g}/preview/start`,{}),onSuccess:()=>{E({title:"Preview starting..."}),setTimeout(()=>C(),2e3)},onError:t=>{E({title:"Failed to start preview",description:t.message,variant:"destructive"})}});l.useEffect(()=>{d?.status==="stopped"&&!M.current&&(M.current=!0,L.mutate(void 0))},[d?.status]);const I=l.useCallback(()=>{const t=x.current;if(t?.contentWindow)try{const s=`
        (function() {
