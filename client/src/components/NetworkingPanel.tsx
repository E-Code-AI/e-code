        ...
        <div className="px-3 py-2">
          <button className="flex items-center gap-1.5 w-full text-left py-1.5" onClick={() => setPortsOpen(!portsOpen)} data-testid="toggle-ports">
            ...
            <div className="flex items-center gap-0.5 ml-auto">
              <Button variant="ghost" size="icon" className="w-5 h-5 text-[var(--ide-text-muted)] hover:text-[var(--ide-text)]" onClick={(e) => { e.stopPropagation(); scanPortsMutation.mutate(undefined); }} title="Auto-detect ports" data-testid="button-scan-ports">
