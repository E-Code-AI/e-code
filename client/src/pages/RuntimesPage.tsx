...
import { LanguageEnvironments } from '@/components/LanguageEnvironments';
                        ...
                        <table className="w-full text-sm mt-1">
                          <tbody>
                            <tr>
                              ...
                              <td className="py-1 text-muted-foreground">{selectedLanguage}</td>
                            </tr>
                            <tr>
                              <td className="py-1 font-medium">Run Command</td>
                              <td className="py-1 text-muted-foreground font-mono text-xs">{selectedLanguage}</td>
                            </tr>
                            {selectedLanguage && (
                              <tr>
