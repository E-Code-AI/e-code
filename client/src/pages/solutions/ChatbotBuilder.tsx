    ...
    <PublicLayout>
      <div className="container mx-auto px-4 py-12 sm:py-16 md:py-20">
        ...
        <div className="text-center max-w-4xl mx-auto mb-12 sm:mb-16 md:mb-20">
          <Badge className="mb-3 sm:mb-4 px-3 sm:px-4 py-1 sm:py-1.5 text-xs sm:text-sm font-medium bg-gradient-to-r from-violet-500 to-purple-500 text-white border-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mb-12 sm:mb-16 md:mb-20">
          ...
          <Card className="p-4 sm:p-6 hover:shadow-lg transition-shadow" data-testid="card-feature-conversations">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Natural Conversations</h3>
            <p className="text-sm sm:text-base text-muted-foreground">
          ...
          <Card className="p-4 sm:p-6 hover:shadow-lg transition-shadow sm:col-span-2 md:col-span-1" data-testid="card-feature-training">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Custom Training</h3>
            <p className="text-sm sm:text-base text-muted-foreground">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
            {[
              ...
              <Card key={useCase} className="p-3 sm:p-4 text-center hover:shadow-md transition-shadow" data-testid={`card-usecase-${index}`}>
                ...
                <p className="font-medium text-xs sm:text-sm md:text-base">{useCase}</p>
              </Card>
            ))}
          </div>
        </div>
        ...
        <div className="mb-12 sm:mb-16 md:mb-20">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            <Card className="p-4 sm:p-6 text-center" data-testid="card-deploy-widget">
              ...
              <h3 className="font-semibold text-sm sm:text-base mb-1 sm:mb-2">Website Widget</h3>
              <p className="text-xs sm:text-sm text-muted-foreground">Embed on any website with one line of code</p>
            </Card>
            <Card className="p-4 sm:p-6 text-center" data-testid="card-deploy-messaging">
              ...
              <h3 className="font-semibold text-sm sm:text-base mb-1 sm:mb-2">Messaging Apps</h3>
              <p className="text-xs sm:text-sm text-muted-foreground">WhatsApp, Telegram, Discord, Slack</p>
            </Card>
            <Card className="p-4 sm:p-6 text-center sm:col-span-2 md:col-span-1" data-testid="card-deploy-api">
              ...
              <h3 className="font-semibold text-sm sm:text-base mb-1 sm:mb-2">API Access</h3>
              <p className="text-xs sm:text-sm text-muted-foreground">Integrate with any application via REST API</p>
            </Card>
          </div>
        </div>
