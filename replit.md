...
### UI/UX Decisions
The frontend uses Shadcn/UI with Tailwind CSS and Monaco Editor, adhering to the Replit RUI Design System. It features a mobile-first, responsive design with light/dark modes, a unified IDE layout (Activity Bar, Tab Bar, Status Bar), spring animations, loading skeletons, and touch enhancements.
...
- **Moonshot AI (Kimi):** kimi-k2-0711-preview, kimi-k2-thinking, moonshot-v1-32k, moonshot-v1-128k
