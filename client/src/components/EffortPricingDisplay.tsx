      ...
      <Card className="border bg-card" data-testid="pricing-empty">
        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center py-4 text-center">
            ...
            <p className="text-xs text-muted-foreground mt-1">Start a conversation to see pricing details</p>
          </div>
        </CardContent>
      </Card>
    );
      ...
      <CardContent className="space-y-4">
        <div className="grid gap-3 grid-cols-2 lg:grid-cols-4">
          <div className="p-3 rounded-lg bg-muted/50 border">
            ...
            <div className="text-lg font-bold">{formatCost(report.totalCost)}</div>
          ...
          <div className="p-3 rounded-lg bg-muted/50 border">
            ...
            <div className="text-lg font-bold">{formatCost(todaysCost)}</div>
            <Progress 
          ...
          <div className="p-3 rounded-lg bg-muted/50 border">
            ...
            <div className="text-lg font-bold">{formatNumber(report.totalEffort.tokensUsed)}</div>
            <p className="text-[10px] text-muted-foreground">
          ...
          <div className="p-3 rounded-lg bg-muted/50 border">
            <div className="flex items-center justify-between mb-1">
              <span className="text-xs font-medium text-muted-foreground">Compute</span>
              <Clock className="h-3 w-3 text-muted-foreground" />
            </div>
            <div className="text-lg font-bold">{Math.round(report.totalEffort.computeTime / 60)}m</div>
            <p className="text-[10px] text-muted-foreground">
        ...
        <div className="grid gap-3 grid-cols-3 text-center">
          <div className="p-2 rounded-md bg-muted/30">
            ...
            <div className="text-sm font-medium">{formatNumber(report.totalEffort.codeGenerated)}</div>
