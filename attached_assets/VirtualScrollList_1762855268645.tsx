 ...
 * Supporte 10,000+ éléments sans lag
 */
...
interface VirtualScrollListProps<T> {
  ...
  endReachedThreshold?: number; // Pixels avant la fin pour déclencher onEndReached
}
...
/**
 * Virtual Grid - Pour afficher des grilles de données
 */
...
/**
 * Virtual Tree - Pour afficher des arbres de fichiers
 */
...
export function VirtualTree<T>({
  ...
  // Flatten l'arbre en liste pour virtual scrolling
...
/**
 * Hook pour utiliser Virtual Scroll avec react-window alternative
 */
