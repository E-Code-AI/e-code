import{cW as ne,r as i,dd as U,bu as re,bw as oe,ea as E,bv as ce,j as e,c as v,bQ as F,c6 as V,B as n,e3 as k,e4 as O,e5 as R,R as de,L as me,cs as pe,ce as he,ch as xe,bM as p,bN as P,cU as y,dg as ue,c7 as fe,fs as ge}from"./index-D1H3m0sF.js";import{S as z}from"./slider-BIa6GoNi.js";import{S as ve}from"./switch-BErr8VKn.js";import{S as M}from"./smartphone-CArGVpgs.js";import{T as ye}from"./tablet-aHePBT-Q.js";import{M as D,A as we,e as je,f as Ne}from"./ReplitAgentPanelV3-BG9MGUw2.js";import{a as be,Z as Se}from"./zoom-out-vi13KfGP.js";import{U as Ce,R as Ee}from"./undo-2-BuoZwZYt.js";import{T as ke}from"./type-DrSqWu_n.js";import{B as Oe}from"./bold-fXjUe_s0.js";import{I as Re}from"./italic-7FKDKUHt.js";import{S as Pe}from"./save-D3XtXm8X.js";import"./textarea-jQSIzceC.js";import"./brain-q53j1Wbx.js";import"./AIModelSelector-CG4w49Qp.js";import"./select-CX3m2Gp0.js";import"./chevron-up-CQyRBrO_.js";import"./skeleton-Dzn0qfYB.js";import"./index-C6b1WvAx.js";import"./cpu-zFrSJws3.js";import"./lightbulb-C3MvQWeT.js";import"./LazyAgGrid-XwbkkG9q.js";import"./table-tUqVY_qm.js";import"./activity-CJL0m7Ad.js";import"./minimize-2-DRe54DOh.js";import"./maximize-2-DfoqPN0h.js";import"./table-2-BZFdu7eE.js";import"./pause-BJE1aYjm.js";import"./test-tube-BSw87rYf.js";import"./rotate-ccw-CZfVqKeX.js";import"./circle-x-BB4ywlLj.js";import"./video-Belb1ymW.js";import"./circle-play-DP2OEAxa.js";import"./external-link-ix-nh_1k.js";import"./volume-x-C8eW2Vn3.js";import"./volume-2-CTXT3HH3.js";import"./link-2-u7okCk29.js";import"./target-Cq_TUqlR.js";import"./filter-D2QQD4cZ.js";import"./command-qKGFkb4H.js";import"./file-plus-Cnu8FH3z.js";import"./timer-DB97RJwk.js";import"./minus-D_UzWK3c.js";import"./square-pen-J-JXKCaI.js";import"./LightSyntaxHighlighter-V2zyFd3M.js";import"./index--5r8SBPn.js";import"./use-reduced-motion-BB8Dvm9C.js";import"./wand-sparkles-pKddUTzC.js";import"./alert-dialog-BpVMkaMn.js";import"./mic-BscV3Dho.js";import"./send-CEjdRpZr.js";const H=[{name:"Mobile S",width:320,height:568,icon:M},{name:"Mobile M",width:375,height:667,icon:M},{name:"Mobile L",width:425,height:812,icon:M},{name:"Tablet",width:768,height:1024,icon:ye},{name:"Laptop",width:1024,height:768,icon:U},{name:"Desktop",width:1440,height:900,icon:U}],$=["#000000","#1f2937","#374151","#6b7280","#9ca3af","#d1d5db","#ef4444","#f97316","#f59e0b","#eab308","#84cc16","#22c55e","#14b8a6","#06b6d4","#0ea5e9","#3b82f6","#6366f1","#8b5cf6","#a855f7","#d946ef","#ec4899","#f43f5e","#ffffff","transparent"];function Ot({projectId:g,onCodeChange:w,className:q}){ne();const x=i.useRef(null),_=i.useRef(!1),[c,Z]=i.useState(!1),[a,j]=i.useState(null),[N,Q]=i.useState(null),[r,b]=i.useState({}),[u,T]=i.useState(""),[m,X]=i.useState(H[5]),[f,A]=i.useState(100),[S,G]=i.useState(!0),[Y,J]=i.useState([]),[K,ee]=i.useState([]),{data:d,isLoading:te,refetch:C}=re({queryKey:["/api/preview/url",g],queryFn:async()=>{const t=await fetch(`/api/preview/url?projectId=${g}`,{credentials:"include"});if(!t.ok)throw new Error("Failed to get preview status");return t.json()},enabled:!!g,refetchInterval:t=>{const s=t.state.data;return s?.status==="starting"?2e3:s?.status==="running"?1e4:!1}}),L=oe({mutationFn:async()=>ce("POST",`/api/preview/projects/${g}/preview/start`,{}),onSuccess:()=>{E({title:"Preview starting..."}),setTimeout(()=>C(),2e3)},onError:t=>{E({title:"Failed to start preview",description:t.message,variant:"destructive"})}});i.useEffect(()=>{d?.status==="stopped"&&!_.current&&(_.current=!0,L.mutate(void 0))},[d?.status]);const I=i.useCallback(()=>{const t=x.current;if(t?.contentWindow)try{const s=`
        (function() {
