...
- **Nix Packages (Deployment)**: Only lightweight runtimes kept in `.replit` nix packages to prevent security scan timeout: `python3`, `gcc`, `gnumake`, `jdk21_headless`, `lua5_4`, `nasm`, `ruby_3_3`, `php82`, `kotlin`, `scala_3`, `clojure`, `elixir`, `ocaml`, plus `glibcLocales`, `jq`, `libxcrypt`. Heavy runtimes (`ghc`, `swift`, `dart`, `dotnet-sdk`, `rustc`, `cargo`, `go`, `julia`, `R`, `zig`, `deno`) were removed — they caused the 9-minute deployment timeout.
