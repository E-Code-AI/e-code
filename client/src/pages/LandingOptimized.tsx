...
export default function LandingOptimized() {
  ...
  const examples = [
    ...
    { icon: <Bot className="h-4 w-4" />, label: "AI Assistant", text: "Build an intelligent AI chatbot with OpenAI GPT-5 integration, conversation memory, document upload for RAG knowledge base, streaming responses", color: "from-ecode-orange to-ecode-orange-hover", id: "chatbot" },
