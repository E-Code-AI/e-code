    ...
    // Slide 1: Cover
    {
      ...
      content: (
        <div className="flex flex-col items-center justify-center h-full text-center">
          ...
          <p className="mt-8 text-lg text-gray-600">Platform: <span className="text-blue-600 font-semibold">e-code.ai</span></p>
        </div>
      )
    },
    // Slide 2: The Problem
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">28M users</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">4.2M teams</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">180K institutions</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">15K organizations</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="h-full flex flex-col justify-center">
          ...
          <div className="grid grid-cols-3 gap-6 mb-10">
            <div className="text-center p-6 bg-blue-50 rounded-lg">
              ...
              <h3 className="font-bold text-lg mb-2">AI Agent</h3>
              <p className="text-sm text-gray-600">Build complete apps from natural language (Claude 4 Sonnet)</p>
            </div>
            <div className="text-center p-6 bg-green-50 rounded-lg">
              ...
              <p className="text-sm text-gray-600">Zero-config development environments</p>
            </div>
            <div className="text-center p-6 bg-purple-50 rounded-lg">
              ...
              <h3 className="font-bold text-lg mb-2">Global Infrastructure</h3>
              <p className="text-sm text-gray-600">5 regions, edge deployment</p>
            </div>
            <div className="text-center p-6 bg-orange-50 rounded-lg">
              ...
              <h3 className="font-bold text-lg mb-2">One-Click Deploy</h3>
              <p className="text-sm text-gray-600">From code to production instantly</p>
            </div>
            <div className="text-center p-6 bg-pink-50 rounded-lg">
              ...
              <p className="text-sm text-gray-600">Up to 4 developers simultaneously</p>
            </div>
            <div className="text-center p-6 bg-indigo-50 rounded-lg">
              ...
              <p className="text-sm text-gray-600">GPU computing, database hosting, object storage</p>
            </div>
          </div>
          ...
          <div className="bg-blue-50 p-6 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white p-4 rounded">
                ...
                <p className="text-sm text-gray-600">April 2022 - $1.16B valuation</p>
              </div>
              <div className="bg-white p-4 rounded">
                <p className="font-semibold">Cursor: $60M Series A</p>
                <p className="text-sm text-gray-600">July 2024 - $400M valuation</p>
              </div>
              <div className="bg-white p-4 rounded">
                <p className="font-semibold">v0 (Vercel): $250M Series E</p>
                <p className="text-sm text-gray-600">May 2024 - $2.25B valuation</p>
              </div>
              <div className="bg-white p-4 rounded">
                <p className="font-semibold">Bolt.new: $450M Series D</p>
                <p className="text-sm text-gray-600">October 2024 - $6B valuation</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-8 mb-8">
            ...
            <div className="space-y-6">
              <div className="bg-gray-100 p-4 rounded-lg">
                ...
                <p className="text-sm">React.js + TypeScript + Tailwind CSS</p>
                <p className="text-sm">Monaco Editor (VS Code engine)</p>
                <p className="text-sm">Real-time WebSocket collaboration</p>
              </div>
              
              <div className="bg-gray-100 p-4 rounded-lg">
                <h4 className="font-bold mb-2 text-gray-800">Backend Stack</h4>
                <p className="text-sm">Node.js + Express + PostgreSQL</p>
                <p className="text-sm">Drizzle ORM + Docker containerization</p>
                <p className="text-sm">Kubernetes orchestration</p>
              </div>
              
              <div className="bg-gray-100 p-4 rounded-lg">
                <h4 className="font-bold mb-2 text-gray-800">AI/ML Integration</h4>
                <p className="text-sm">Anthropic Claude 4 Sonnet</p>
                <p className="text-sm">Advanced context awareness</p>
                <p className="text-sm">Multi-modal code generation</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-lg">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">5 regions globally</p>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">Sub-50ms latency</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="h-full flex flex-col justify-center">
          ...
          <div className="grid grid-cols-4 gap-4">
            <div className="bg-green-50 p-4 rounded-lg text-center">
              ...
              <p className="text-xs text-gray-500">(vs 2+ hours)</p>
            </div>
            <div className="bg-blue-50 p-4 rounded-lg text-center">
              <p className="text-3xl font-bold text-blue-600">2,000+</p>
              <p className="text-sm text-gray-600">Lines generated</p>
            </div>
            <div className="bg-purple-50 p-4 rounded-lg text-center">
              <p className="text-3xl font-bold text-purple-600">3 min</p>
              <p className="text-sm text-gray-600">To deployment</p>
            </div>
            <div className="bg-orange-50 p-4 rounded-lg text-center">
              <p className="text-3xl font-bold text-orange-600">&lt;50ms</p>
              <p className="text-sm text-gray-600">Collab latency</p>
            </div>
          </div>
        </div>
      )
        ...
        <div className="h-full overflow-y-auto">
          ...
          <div className="grid grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-lg">
              ...
              <p className="text-lg font-semibold mb-3">6 GPU Types (vs Replit's 2-3)</p>
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <p className="text-sm mb-2"><strong>7 OAuth Providers:</strong></p>
                <p className="text-sm text-gray-600">GitHub, Google, GitLab, Bitbucket, Discord, Slack, Azure AD</p>
          ...
          <div className="mt-8 bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-lg">
            ...
            <div className="grid grid-cols-4 gap-4 text-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">AI-generated lines</p>
              </div>
              <div>
            ...
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <div className="space-y-3">
                <div className="bg-white p-3 rounded">
                  ...
                  <p className="text-sm text-gray-500 mt-1">Public projects only</p>
                </div>
                <div className="bg-white p-3 rounded">
                  <div className="flex justify-between items-center">
                  ...
                  <p className="text-sm text-gray-500 mt-1">Private projects, AI features, $25 credits</p>
                </div>
                <div className="bg-white p-3 rounded">
                  <div className="flex justify-between items-center">
                  ...
                  <p className="text-sm text-gray-500 mt-1">Team management, $40 credits, advanced</p>
                </div>
                <div className="bg-white p-3 rounded">
                  <div className="flex justify-between items-center">
                  ...
                  <p className="text-sm text-gray-500 mt-1">SSO, compliance, dedicated support</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-50 p-6 rounded-lg">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm bg-green-100 px-2 py-1 rounded">$0.35-$8.00/hr (40% margin)</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-semibold">AI Agent Usage</span>
                  <span className="text-sm bg-green-100 px-2 py-1 rounded">$0.10-$2.00/generation</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-semibold">Deployment</span>
                  <span className="text-sm bg-green-100 px-2 py-1 rounded">$0.02/hr + bandwidth</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-semibold">Storage & Database</span>
                  <span className="text-sm bg-green-100 px-2 py-1 rounded">$0.15/GB/month</span>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-gray-600">6,000 users, 0.024% market</p>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-gray-600">25,000 users, 0.10% market</p>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-gray-600">100,000 users, 0.35% market</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-gray-600">300,000 users, 1.2% market</p>
                    </div>
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-gray-600">500,000 users, 1.8% market</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Higher ARPU, longer contracts</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">High margin compute revenue</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">EU, APAC expansion</p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Marketplace revenue share</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 p-6 rounded-lg">
              ...
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  <p className="font-bold text-lg">CEO/CTO</p>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-lg mb-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="bg-green-100 px-3 py-1 rounded-full text-sm">12 people</span>
                  </div>
                  <p className="text-sm text-gray-600 ml-4">Average 12 years experience, top-tier companies</p>
                  
                  <div className="flex justify-between items-center">
                    <span className="font-semibold">AI/ML Engineers</span>
                    <span className="bg-green-100 px-3 py-1 rounded-full text-sm">4 people</span>
                  </div>
                  <p className="text-sm text-gray-600 ml-4">PhD-level expertise, published researchers</p>
                  
                  <div className="flex justify-between items-center">
                    <span className="font-semibold">DevOps/Infrastructure</span>
                    <span className="bg-green-100 px-3 py-1 rounded-full text-sm">3 people</span>
                  </div>
                  <p className="text-sm text-gray-600 ml-4">Kubernetes and cloud architecture specialists</p>
                  
                  <div className="flex justify-between items-center">
                    <span className="font-semibold">Security Engineers</span>
                    <span className="bg-green-100 px-3 py-1 rounded-full text-sm">2 people</span>
                  </div>
                  <p className="text-sm text-gray-600 ml-4">Enterprise compliance and cybersecurity</p>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 p-6 rounded-lg">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">Scale team, enhance AI capabilities</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">Enterprise go-to-market execution</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">Global expansion, compute capacity</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">Legal, security, enterprise readiness</p>
                </div>
              </div>
            </div>
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Fortune 5000 companies</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">EU and APAC operations</p>
                    </div>
                  </li>
                  <li className="flex items-start">
