    ...
    try {
      const aboutData = {
        ...
        milestones: [
          ...
          { year: '2025', event: 'Announced $180M Series B funding and global debut of the Vibe platform.' },
          { year: '2025', event: 'Expanded Fortune 500 partnerships with managed compliance and AI governance.' }
        ],
        team: [
