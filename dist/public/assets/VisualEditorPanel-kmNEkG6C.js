import{b0 as ne,r as l,bj as F,F as re,H as oe,cb as E,G as ce,j as e,c as v,a4 as U,al as V,B as n,c5 as k,c6 as O,c7 as R,R as de,L as me,aE as pe,at as he,au as xe,a0 as p,a1 as P,a_ as y,bm as ue,am as fe,dn as ge}from"./index-B7jaigeE.js";import{S as _}from"./slider-BNk4cYwZ.js";import{S as ve}from"./switch-CsVMNu6G.js";import{S as z}from"./smartphone-DCVZqOR9.js";import{T as ye}from"./tablet-C3l-1FXV.js";import{M as H,A as we,e as je,f as Ne}from"./ReplitAgentPanelV3-CPkOUrF1.js";import{a as be,Z as Se}from"./zoom-out-q4wdrc6i.js";import{U as Ce,R as Ee}from"./undo-2-B2BuKkIx.js";import{T as ke}from"./type-DCd6WDmZ.js";import{B as Oe}from"./bold-BWZ1utHC.js";import{I as Re}from"./italic-C8hPIs77.js";import{S as Pe}from"./save-Caqv3L5j.js";import"./index-DQ99p1kl.js";import"./textarea-D84uHNVd.js";import"./card-DVHmKOEr.js";import"./brain-D28IPvQU.js";import"./circle-check-big-BJUIekrE.js";import"./AIModelSelector-20Hms5nC.js";import"./select-BcNMDhpH.js";import"./chevron-up-BGtZJdxt.js";import"./skeleton-BMcJa-Lj.js";import"./index-C3Pr3pqh.js";import"./cpu-BF0uR6ju.js";import"./lightbulb-DMsa6Xvk.js";import"./LazyAgGrid-CVkumvP7.js";import"./table-CDAhBjTW.js";import"./chevron-left-CKYU8f7Q.js";import"./activity-Cwz5WULB.js";import"./minimize-2-Bjd6HTmd.js";import"./maximize-2-CiPGYclA.js";import"./table-2-C4qnDeQF.js";import"./pause-DzJbDVFT.js";import"./test-tube-DmVcKFRr.js";import"./rotate-ccw-CEt3RHke.js";import"./circle-x-CyNGWrD0.js";import"./video-Di_fxuPG.js";import"./circle-play-BwLTMSpj.js";import"./external-link-BPvn_juN.js";import"./volume-x-BJJ155yd.js";import"./volume-2-C6DRP0n9.js";import"./link-2-BdC3yaVd.js";import"./target-CHX3UKIN.js";import"./filter-Bq1Lag6B.js";import"./command-BFVeM2hi.js";import"./file-plus-2OF33tCh.js";import"./timer-BLo-zSBK.js";import"./minus-B6l7omMA.js";import"./square-pen-DPeEWmeQ.js";import"./LightSyntaxHighlighter-D1v1kU4G.js";import"./index-BoR9f2Hx.js";import"./use-reduced-motion-DVpyG2I8.js";import"./wand-sparkles-CX3JzaW-.js";import"./alert-dialog-Ch2XH8lF.js";import"./mic-DKL7DGKv.js";import"./send-DKWfaZ-R.js";const D=[{name:"Mobile S",width:320,height:568,icon:z},{name:"Mobile M",width:375,height:667,icon:z},{name:"Mobile L",width:425,height:812,icon:z},{name:"Tablet",width:768,height:1024,icon:ye},{name:"Laptop",width:1024,height:768,icon:F},{name:"Desktop",width:1440,height:900,icon:F}],$=["#000000","#1f2937","#374151","#6b7280","#9ca3af","#d1d5db","#ef4444","#f97316","#f59e0b","#eab308","#84cc16","#22c55e","#14b8a6","#06b6d4","#0ea5e9","#3b82f6","#6366f1","#8b5cf6","#a855f7","#d946ef","#ec4899","#f43f5e","#ffffff","transparent"];function zt({projectId:g,onCodeChange:w,className:q}){ne();const x=l.useRef(null),M=l.useRef(!1),[c,Z]=l.useState(!1),[a,j]=l.useState(null),[N,G]=l.useState(null),[r,b]=l.useState({}),[u,T]=l.useState(""),[m,X]=l.useState(D[5]),[f,A]=l.useState(100),[S,Q]=l.useState(!0),[Y,J]=l.useState([]),[K,ee]=l.useState([]),{data:d,isLoading:te,refetch:C}=re({queryKey:["/api/preview/url",g],queryFn:async()=>{const t=await fetch(`/api/preview/url?projectId=${g}`,{credentials:"include"});if(!t.ok)throw new Error("Failed to get preview status");return t.json()},enabled:!!g,refetchInterval:t=>{const s=t.state.data;return s?.status==="starting"?2e3:s?.status==="running"?1e4:!1}}),L=oe({mutationFn:async()=>ce("POST",`/api/preview/projects/${g}/preview/start`,{}),onSuccess:()=>{E({title:"Preview starting..."}),setTimeout(()=>C(),2e3)},onError:t=>{E({title:"Failed to start preview",description:t.message,variant:"destructive"})}});l.useEffect(()=>{d?.status==="stopped"&&!M.current&&(M.current=!0,L.mutate(void 0))},[d?.status]);const I=l.useCallback(()=>{const t=x.current;if(t?.contentWindow)try{const s=`
        (function() {
