    ...
    <PageShell>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
              ...
              <DialogContent className="max-w-lg">
                ...
                <DialogFooter>
                  <Button variant="outline" onClick={() => { setShowAddDialog(false); resetNewEntry(); }}>
                    Cancel
                  </Button>
                  <Button 
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card data-testid="card-stat-keys">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats?.totalKeys || entries.length}</div>
        ...
        <Card data-testid="card-stat-avg-size">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatSize(stats?.avgValueSize || 0)}</div>
        ...
        <Card data-testid="card-stat-expiring">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-yellow-500">{stats?.expiringKeys || 0}</div>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-2 flex-wrap">
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="font-mono font-medium text-sm truncate max-w-[200px]" title={entry.key}>
                            {entry.key}
                          </span>
                        </div>
      ...
      <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Modify the value for key: <code className="font-mono bg-muted px-1 rounded">{selectedEntry?.key}</code>
            </DialogDescription>
          </DialogHeader>
          {selectedEntry && (
            <div className="space-y-4">
