    ...
    <AdminLayout>
      <div className="p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6 lg:space-y-8">
        <div className="mb-4 sm:mb-6 lg:mb-8">
          ...
          <p className="text-xs sm:text-sm text-zinc-400" data-testid="text-dashboard-subtitle">Overview of your platform statistics</p>
        </div>
            ...
            {statCards.map((stat) => {
              ...
              return (
                <Card key={stat.title} className="bg-zinc-800 border-zinc-700 hover:border-zinc-600 transition-colors" data-testid={`card-stat-${stat.title.toLowerCase().replace(/\s+/g, '-')}`}>
                  ...
                  <CardContent className="p-3 sm:p-4 pt-0">
                    <div className="text-lg sm:text-2xl font-bold text-white" data-testid={`text-stat-${stat.title.toLowerCase().replace(/\s+/g, '-')}-value`}>{stat.value}</div>
        ...
        <div className="mt-4 sm:mt-6 lg:mt-8">
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <h2 className="text-base sm:text-lg lg:text-xl font-semibold text-white" data-testid="heading-ai-provider-health">AI Provider Health</h2>
                    ...
                    return (
                      <div key={provider.provider} className="flex items-center justify-between p-3 bg-zinc-900 rounded-lg border border-zinc-800" data-testid={`card-provider-${provider.provider.toLowerCase()}`}>
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="text-sm font-medium text-white capitalize" data-testid={`text-provider-${provider.provider.toLowerCase()}-name`}>{provider.provider}</p>
                            {provider.error && (
        ...
        {/* Recent Activity */}
        <div className="mt-4 sm:mt-6 lg:mt-8">
          <h2 className="text-base sm:text-lg lg:text-xl font-semibold text-white mb-3 sm:mb-4" data-testid="heading-recent-activity">Recent Activity</h2>
          <Card className="bg-zinc-800 border-zinc-700">
            <CardContent className="p-3 sm:p-4 lg:p-6">
              <div className="space-y-4">
        ...
        {/* Quick Actions */}
        <div className="mt-4 sm:mt-6 lg:mt-8">
          <h2 className="text-base sm:text-lg lg:text-xl font-semibold text-white mb-3 sm:mb-4" data-testid="heading-quick-actions">Quick Actions</h2>
