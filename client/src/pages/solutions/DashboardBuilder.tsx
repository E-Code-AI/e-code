    ...
    <PublicLayout>
      <div className="container mx-auto px-4 py-12 sm:py-16 md:py-20">
        ...
        <div className="text-center max-w-4xl mx-auto mb-12 sm:mb-16 md:mb-20">
          <Badge className="mb-3 sm:mb-4 px-3 sm:px-4 py-1 sm:py-1.5 text-xs sm:text-sm font-medium bg-gradient-to-r from-indigo-500 to-blue-500 text-white border-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mb-12 sm:mb-16 md:mb-20">
          <Card className="p-4 sm:p-6 hover:shadow-lg transition-shadow" data-testid="card-feature-visualizations">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Rich Visualizations</h3>
          ...
          <Card className="p-4 sm:p-6 hover:shadow-lg transition-shadow" data-testid="card-feature-data">
            ...
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Connect Any Data</h3>
            <p className="text-sm sm:text-base text-muted-foreground">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
            {[
              ...
              <Card key={dashType} className="p-3 sm:p-4 text-center hover:shadow-md transition-shadow" data-testid={`card-dashtype-${index}`}>
                ...
                <p className="font-medium text-xs sm:text-sm md:text-base">{dashType}</p>
              </Card>
            ))}
          </div>
        </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6 sm:gap-8">
            <div className="space-y-4" data-testid="viz-group-1">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-sm sm:text-base">Pie & Donut Charts</h3>
                  <p className="text-xs sm:text-sm text-muted-foreground">Perfect for showing proportions and percentages</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <BarChart3 className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-sm sm:text-base">Bar & Column Charts</h3>
                  <p className="text-xs sm:text-sm text-muted-foreground">Compare values across categories</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <TrendingUp className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-sm sm:text-base">Line & Area Charts</h3>
                  <p className="text-xs sm:text-sm text-muted-foreground">Show trends and changes over time</p>
                </div>
              </div>
            </div>
            <div className="space-y-4" data-testid="viz-group-2">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-sm sm:text-base">Heatmaps</h3>
                  <p className="text-xs sm:text-sm text-muted-foreground">Visualize data density and patterns</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <Database className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-sm sm:text-base">Data Tables</h3>
                  <p className="text-xs sm:text-sm text-muted-foreground">Sortable, filterable data grids</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <Zap className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-sm sm:text-base">KPI Cards</h3>
                  <p className="text-xs sm:text-sm text-muted-foreground">Highlight key metrics and indicators</p>
                </div>
              </div>
            </div>
          </div>
