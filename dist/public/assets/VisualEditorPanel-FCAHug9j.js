import{cT as ne,r as i,dg as U,bB as re,bC as oe,eb as E,e as ce,j as e,bX as F,cc as V,B as n,c as v,e6 as k,e7 as O,e8 as R,R as de,L as me,cx as pe,cj as he,cm as xe,bT as p,bU as P,cX as y,dj as ue,X as fe,fu as ge}from"./index-DyLSiGVT.js";import{S as T}from"./slider-DTwiPG5c.js";import{S as ve}from"./switch-D4BHslT_.js";import{S as z}from"./smartphone-DbSlyw7S.js";import{T as ye}from"./tablet-CRuYKV0u.js";import{M as D,e as we,f as je,h as Ne}from"./ReplitAgentPanelV3-yf3Y5Ulj.js";import{a as be,Z as Se}from"./zoom-out-CFKsLdfd.js";import{U as Ce,R as Ee}from"./undo-2-Up4-cEwe.js";import{T as ke}from"./type-DWx5eFXP.js";import{B as Oe}from"./bold-BKAwrjLz.js";import{I as Re}from"./italic-BeesD721.js";import{S as Pe}from"./save-DbSCF1zT.js";import"./textarea-CrzMx-Kv.js";import"./brain-C6b4AFBm.js";import"./AIModelSelector-B02g1OCU.js";import"./select-BGaIaFr1.js";import"./chevron-up-C8bmSb7h.js";import"./skeleton-xYEZEkXq.js";import"./index-f89972MF.js";import"./cpu-C5iznQnI.js";import"./lightbulb-DYylzhdp.js";import"./LazyAgGrid-EnZoisoa.js";import"./table-BR1riHYs.js";import"./activity-DwXBmlFv.js";import"./minimize-2-DFvVaAJT.js";import"./maximize-2-CXBEMFtl.js";import"./table-2-4zNC3cW1.js";import"./pause-B1avvUvp.js";import"./test-tube-BmzmJ0U6.js";import"./rotate-ccw-BV12ZPln.js";import"./video-bCPEwYkA.js";import"./circle-play-DZYgkIQ-.js";import"./external-link-DZgRyCq8.js";import"./volume-x-C5kUHF8x.js";import"./volume-2-DAPKKiCB.js";import"./link-2-BmIuCLZu.js";import"./target-B7s87fcc.js";import"./filter-sb6AYS_u.js";import"./command-CoxHjHLP.js";import"./file-plus-CMwzDQxD.js";import"./timer-CNuUCie4.js";import"./minus-COD0IUZ6.js";import"./square-pen-3LCSs4bv.js";import"./LightSyntaxHighlighter-DNW_vV9d.js";import"./index-DUUUnotA.js";import"./use-reduced-motion-B5mzp6AX.js";import"./wand-sparkles-BInYN7Eh.js";import"./alert-dialog-CgnmD5Ii.js";import"./mic-CsNMOyfz.js";import"./send-BrNejir3.js";const H=[{name:"Mobile S",width:320,height:568,icon:z},{name:"Mobile M",width:375,height:667,icon:z},{name:"Mobile L",width:425,height:812,icon:z},{name:"Tablet",width:768,height:1024,icon:ye},{name:"Laptop",width:1024,height:768,icon:U},{name:"Desktop",width:1440,height:900,icon:U}],X=["#000000","#1f2937","#374151","#6b7280","#9ca3af","#d1d5db","#ef4444","#f97316","#f59e0b","#eab308","#84cc16","#22c55e","#14b8a6","#06b6d4","#0ea5e9","#3b82f6","#6366f1","#8b5cf6","#a855f7","#d946ef","#ec4899","#f43f5e","#ffffff","transparent"];function kt({projectId:g,onCodeChange:w,className:$}){ne();const x=i.useRef(null),_=i.useRef(!1),[c,q]=i.useState(!1),[a,j]=i.useState(null),[N,Z]=i.useState(null),[r,b]=i.useState({}),[u,M]=i.useState(""),[m,G]=i.useState(H[5]),[f,L]=i.useState(100),[S,Q]=i.useState(!0),[Y,J]=i.useState([]),[K,ee]=i.useState([]),{data:d,isLoading:te,refetch:C}=re({queryKey:["/api/preview/url",g],queryFn:async()=>{const t=await fetch(`/api/preview/url?projectId=${g}`,{credentials:"include"});if(!t.ok)throw new Error("Failed to get preview status");return t.json()},enabled:!!g,refetchInterval:t=>{const s=t.state.data;return s?.status==="starting"?2e3:s?.status==="running"?1e4:!1}}),A=oe({mutationFn:async()=>ce("POST",`/api/preview/projects/${g}/preview/start`,{}),onSuccess:()=>{E({title:"Preview starting..."}),setTimeout(()=>C(),2e3)},onError:t=>{E({title:"Failed to start preview",description:t.message,variant:"destructive"})}});i.useEffect(()=>{d?.status==="stopped"&&!_.current&&(_.current=!0,A.mutate(void 0))},[d?.status]);const I=i.useCallback(()=>{const t=x.current;if(t?.contentWindow)try{const s=`
        (function() {
