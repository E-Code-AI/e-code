...
function toggleTodo(id) {
    ...
    if (todo) {
        ...
        saveTodos();
        renderTodos();
        console.log('[TodoApp] Toggled todo:', id, 'completed:', todo.completed);
    }
}
...
function saveTodos() {
    try {
        ...
        console.log('[TodoApp] Saved', todos.length, 'todos to localStorage');
    } catch (e) {
        console.error('[TodoApp] Failed to save todos:', e);
    }
}
...
function loadTodos() {
    try {
        ...
        if (saved) {
            ...
            console.log('[TodoApp] Loaded', todos.length, 'todos from localStorage');
        }
    } catch (e) {
        console.error('[TodoApp] Failed to load todos:', e);
        todos = [];
    }
}
