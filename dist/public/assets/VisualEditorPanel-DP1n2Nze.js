import{b0 as ne,r as l,bj as F,F as re,H as oe,cb as E,G as ce,j as e,c as v,a4 as U,al as V,B as n,c5 as k,c6 as O,c7 as R,R as de,L as me,aE as pe,at as he,au as xe,a0 as p,a1 as P,a_ as y,bm as ue,am as fe,dn as ge}from"./index--UcL9vU0.js";import{S as _}from"./slider-Dgb9UpXd.js";import{S as ve}from"./switch-L-IZoEKl.js";import{S as z}from"./smartphone-DGALmuRU.js";import{T as ye}from"./tablet-DG3J3Vl0.js";import{M as H,A as we,e as je,f as Ne}from"./ReplitAgentPanelV3-D9ewDvHD.js";import{a as be,Z as Se}from"./zoom-out-CKnNR6zp.js";import{U as Ce,R as Ee}from"./undo-2-DDH4veZG.js";import{T as ke}from"./type-QyFIdCKZ.js";import{B as Oe}from"./bold-Bslvz2qP.js";import{I as Re}from"./italic-DBT1QNUz.js";import{S as Pe}from"./save-BCuQk77X.js";import"./index-BRPhXkTP.js";import"./textarea-lpjo1eP3.js";import"./card-D78Zhdl2.js";import"./brain-BO6Z55SH.js";import"./circle-check-big-HZYHC3vI.js";import"./AIModelSelector-BnJpbDJJ.js";import"./select-COc6eixl.js";import"./chevron-up-8btfrApr.js";import"./skeleton-D0NpyUqI.js";import"./index-BTym-r0c.js";import"./cpu-WHXIEHm8.js";import"./lightbulb-CGNCpozt.js";import"./LazyAgGrid-C3haRC8r.js";import"./table-BALaiEP-.js";import"./chevron-left-DXqVr-w8.js";import"./activity-ZzTma7cf.js";import"./minimize-2-BVL_qYsM.js";import"./maximize-2-CvLKn_eb.js";import"./table-2-BneD-ZwK.js";import"./pause-CIRzbxM1.js";import"./test-tube-Cjy8LG1o.js";import"./rotate-ccw-BVrFeHjn.js";import"./circle-x-C2yaDS43.js";import"./video-Dk8r85Dq.js";import"./circle-play-BDSYX39g.js";import"./external-link-T0ujSzNH.js";import"./volume-x-CNrdZyAu.js";import"./volume-2-RSDSw5HO.js";import"./link-2-DWkAKuy5.js";import"./target-BiIeROld.js";import"./filter-C86S7p2_.js";import"./command-BIOAlsA8.js";import"./file-plus-DO_vgKR4.js";import"./timer-CwkysaoU.js";import"./minus-tbS4vDBN.js";import"./square-pen-BDuV7ita.js";import"./LightSyntaxHighlighter-DknUEQKC.js";import"./index-B8rhFMuP.js";import"./use-reduced-motion-D_hNaYn3.js";import"./wand-sparkles-D6cPLn_A.js";import"./alert-dialog-NGoaTcaU.js";import"./mic-CKrSuRn8.js";import"./send-ClG2VYbg.js";const D=[{name:"Mobile S",width:320,height:568,icon:z},{name:"Mobile M",width:375,height:667,icon:z},{name:"Mobile L",width:425,height:812,icon:z},{name:"Tablet",width:768,height:1024,icon:ye},{name:"Laptop",width:1024,height:768,icon:F},{name:"Desktop",width:1440,height:900,icon:F}],$=["#000000","#1f2937","#374151","#6b7280","#9ca3af","#d1d5db","#ef4444","#f97316","#f59e0b","#eab308","#84cc16","#22c55e","#14b8a6","#06b6d4","#0ea5e9","#3b82f6","#6366f1","#8b5cf6","#a855f7","#d946ef","#ec4899","#f43f5e","#ffffff","transparent"];function zt({projectId:g,onCodeChange:w,className:q}){ne();const x=l.useRef(null),M=l.useRef(!1),[c,Z]=l.useState(!1),[a,j]=l.useState(null),[N,G]=l.useState(null),[r,b]=l.useState({}),[u,T]=l.useState(""),[m,X]=l.useState(D[5]),[f,A]=l.useState(100),[S,Q]=l.useState(!0),[Y,J]=l.useState([]),[K,ee]=l.useState([]),{data:d,isLoading:te,refetch:C}=re({queryKey:["/api/preview/url",g],queryFn:async()=>{const t=await fetch(`/api/preview/url?projectId=${g}`,{credentials:"include"});if(!t.ok)throw new Error("Failed to get preview status");return t.json()},enabled:!!g,refetchInterval:t=>{const s=t.state.data;return s?.status==="starting"?2e3:s?.status==="running"?1e4:!1}}),L=oe({mutationFn:async()=>ce("POST",`/api/preview/projects/${g}/preview/start`,{}),onSuccess:()=>{E({title:"Preview starting..."}),setTimeout(()=>C(),2e3)},onError:t=>{E({title:"Failed to start preview",description:t.message,variant:"destructive"})}});l.useEffect(()=>{d?.status==="stopped"&&!M.current&&(M.current=!0,L.mutate(void 0))},[d?.status]);const I=l.useCallback(()=>{const t=x.current;if(t?.contentWindow)try{const s=`
        (function() {
