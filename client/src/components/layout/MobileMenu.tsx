                    ...
                    >
                      <div className={`h-10 w-10 rounded-xl flex items-center justify-center transition-all ${
                        ...
                        <link.icon className={`h-5 w-5 ${
                          location === link.path ? 'text-[var(--ecode-text)] dark:text-white' : 'text-[var(--ecode-text-muted)] dark:text-zinc-400'
                        }`} />
                      </div>
                      <div className="flex-1 text-left">
                        <p className={`text-sm font-medium ${
                          location === link.path ? 'text-[var(--ecode-text)] dark:text-white' : 'text-[var(--ecode-text-secondary)] dark:text-zinc-300'
                        }`}>{link.label}</p>
                        {link.label === 'Create App' && (
                          <p className="text-xs text-[var(--ecode-text-muted)] dark:text-zinc-500">Start building instantly</p>
                        )}
                      </div>
                      {link.badge && (
