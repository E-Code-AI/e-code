import{b0 as ne,r as l,bj as F,F as re,H as oe,cb as E,G as ce,j as e,c as v,a4 as U,al as V,B as n,c5 as k,c6 as O,c7 as R,R as de,L as me,aE as pe,at as he,au as xe,a0 as p,a1 as P,a_ as y,bm as ue,am as fe,dn as ge}from"./index-2qiwhdSf.js";import{S as _}from"./slider-D6Fa-XJm.js";import{S as ve}from"./switch-yzsL-_S4.js";import{S as z}from"./smartphone-BM8QkVya.js";import{T as ye}from"./tablet-zWIK8C8u.js";import{M as H,A as we,e as je,f as Ne}from"./ReplitAgentPanelV3-CCvG3Xiu.js";import{a as be,Z as Se}from"./zoom-out-Cuh7dE_4.js";import{U as Ce,R as Ee}from"./undo-2-DCmd5GWA.js";import{T as ke}from"./type-DZADZIZJ.js";import{B as Oe}from"./bold-BdiF2aP7.js";import{I as Re}from"./italic-BG3_sOVc.js";import{S as Pe}from"./save-Dz8cqWVN.js";import"./index-BxTGRXBj.js";import"./textarea-CBKoo4iT.js";import"./card-Bp-TGkxQ.js";import"./brain-eFCW734E.js";import"./circle-check-big-Dn7as18s.js";import"./AIModelSelector-C7XXzviF.js";import"./select-CyI-bZmk.js";import"./chevron-up-NGvQi1mj.js";import"./skeleton-BmLe1fWg.js";import"./index-h-JVdPMT.js";import"./cpu-BMXQW53l.js";import"./lightbulb-C1T9Kx_Q.js";import"./LazyAgGrid-B1FNOE9u.js";import"./table-oGXR5lei.js";import"./chevron-left-CMRnSE_j.js";import"./activity-CLQvbwXI.js";import"./minimize-2-oR37iWqq.js";import"./maximize-2-CaSmJJCP.js";import"./table-2-GJZJLruL.js";import"./pause-D0zF04RB.js";import"./test-tube-DVD9TmAr.js";import"./rotate-ccw-DS48WHzR.js";import"./circle-x-CGyYMlfk.js";import"./video-D45HS8nE.js";import"./circle-play-CsM0epcD.js";import"./external-link-BQlrhIKJ.js";import"./volume-x-DvIYgYKw.js";import"./volume-2-DzV0v44P.js";import"./link-2-BwSBlVQp.js";import"./target-5REPOF_8.js";import"./filter-CEyUXQQ1.js";import"./command-C33Z6m93.js";import"./file-plus-uT0lrRzs.js";import"./timer-DQmr5Qjx.js";import"./minus--AGTsg-P.js";import"./square-pen-BI8nRybo.js";import"./LightSyntaxHighlighter-BvFuqebq.js";import"./index-QPsoeTqh.js";import"./use-reduced-motion-CRc0v5Tn.js";import"./wand-sparkles-CvLX8ipl.js";import"./alert-dialog-beuGwRR8.js";import"./mic-D7bgjyY6.js";import"./send-waDZEHu8.js";const D=[{name:"Mobile S",width:320,height:568,icon:z},{name:"Mobile M",width:375,height:667,icon:z},{name:"Mobile L",width:425,height:812,icon:z},{name:"Tablet",width:768,height:1024,icon:ye},{name:"Laptop",width:1024,height:768,icon:F},{name:"Desktop",width:1440,height:900,icon:F}],$=["#000000","#1f2937","#374151","#6b7280","#9ca3af","#d1d5db","#ef4444","#f97316","#f59e0b","#eab308","#84cc16","#22c55e","#14b8a6","#06b6d4","#0ea5e9","#3b82f6","#6366f1","#8b5cf6","#a855f7","#d946ef","#ec4899","#f43f5e","#ffffff","transparent"];function zt({projectId:g,onCodeChange:w,className:q}){ne();const x=l.useRef(null),M=l.useRef(!1),[c,Z]=l.useState(!1),[a,j]=l.useState(null),[N,G]=l.useState(null),[r,b]=l.useState({}),[u,T]=l.useState(""),[m,X]=l.useState(D[5]),[f,A]=l.useState(100),[S,Q]=l.useState(!0),[Y,J]=l.useState([]),[K,ee]=l.useState([]),{data:d,isLoading:te,refetch:C}=re({queryKey:["/api/preview/url",g],queryFn:async()=>{const t=await fetch(`/api/preview/url?projectId=${g}`,{credentials:"include"});if(!t.ok)throw new Error("Failed to get preview status");return t.json()},enabled:!!g,refetchInterval:t=>{const s=t.state.data;return s?.status==="starting"?2e3:s?.status==="running"?1e4:!1}}),L=oe({mutationFn:async()=>ce("POST",`/api/preview/projects/${g}/preview/start`,{}),onSuccess:()=>{E({title:"Preview starting..."}),setTimeout(()=>C(),2e3)},onError:t=>{E({title:"Failed to start preview",description:t.message,variant:"destructive"})}});l.useEffect(()=>{d?.status==="stopped"&&!M.current&&(M.current=!0,L.mutate(void 0))},[d?.status]);const I=l.useCallback(()=>{const t=x.current;if(t?.contentWindow)try{const s=`
        (function() {
