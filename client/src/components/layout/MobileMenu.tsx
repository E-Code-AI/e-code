        ...
        >
          ...
          <ScrollArea className="h-[calc(100vh-88px)]">
            <div className="px-6 py-6">
              ...
              {/* Settings & Account - for authenticated users */}
              {user ? (
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: isVisible ? 1 : 0 }}
                ...
                <motion.div
                  ...
                  className="space-y-2 mb-8"
                >
                  <h3 className="text-xs font-semibold text-zinc-500 uppercase tracking-wider mb-3 px-1">Get Started</h3>
                  <button
                    className="w-full p-3 rounded-xl bg-gradient-to-r from-purple-600/20 to-blue-600/20 border border-purple-500/30 hover:from-purple-600/30 hover:to-blue-600/30 transition-all flex items-center gap-3 group"
                  ...
                  <button
                    className="w-full p-3 rounded-xl bg-zinc-800/30 border border-zinc-700/50 hover:bg-zinc-800/50 transition-colors flex items-center gap-3 group"
                    onClick={() => handleNavigate('/register')}
                  >
                    <Sparkles className="h-5 w-5 text-zinc-400 group-hover:text-zinc-300" />
                    <span className="text-sm text-zinc-300">Sign up</span>
                  </button>
                </motion.div>
              )}
