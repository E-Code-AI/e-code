...
const MOCK_PROBLEMS: Problem[] = [
  {
    ...
    path: 'client/src/components/AIAssistant.tsx',
    line: 68,
    column: 15,
    ...
    quickFixes: [
      { id: 'qf1', title: 'Remove unused import', description: 'Remove the unused React import', isPreferred: true },
      { id: 'qf2', title: 'Disable rule for this line', description: 'Add eslint-disable-next-line comment' },
    ],
  },
  {
    id: '2',
    ...
    line: 125,
    column: 5,
    message: "Missing dependency 'projectId' in useEffect dependency array.",
    severity: 'warning',
    source: 'eslint',
    code: 'react-hooks/exhaustive-deps',
    quickFixes: [
      { id: 'qf3', title: 'Add missing dependency', description: "Add 'projectId' to the dependency array", isPreferred: true },
    ],
  },
  {
    id: '3',
    ...
    code: 'TS2322',
    quickFixes: [
      { id: 'qf4', title: 'Add type assertion', description: 'Assert value as string', isPreferred: true },
      { id: 'qf5', title: 'Add null check', description: 'Add conditional check before assignment' },
    ],
  },
  {
    id: '4',
    ...
    line: 156,
    column: 3,
    message: "Using 'any' type is discouraged.",
    severity: 'warning',
    source: 'eslint',
    code: '@typescript-eslint/no-explicit-any',
    quickFixes: [
      { id: 'qf6', title: 'Replace with unknown', description: 'Use unknown instead of any' },
    ],
  },
  {
    id: '5',
    ...
    line: 18,
    column: 1,
    message: "Prefer using nullish coalescing operator (??) instead of logical OR (||).",
    severity: 'info',
    source: 'eslint',
    code: '@typescript-eslint/prefer-nullish-coalescing',
    quickFixes: [
      { id: 'qf7', title: 'Use nullish coalescing', description: 'Replace || with ??', isPreferred: true },
    ],
  },
  {
    id: '6',
    ...
    line: 32,
    column: 8,
    message: "Property 'createdAt' has no initializer.",
    severity: 'error',
    source: 'typescript',
    code: 'TS2564',
    quickFixes: [
      { id: 'qf8', title: 'Add default value', description: 'Initialize with default Date' },
    ],
  },
  {
    id: '7',
  ...
  },
  {
    ...
    code: 'require-await',
    quickFixes: [
      { id: 'qf9', title: 'Remove async keyword', description: 'Function can be synchronous', isPreferred: true },
    ],
  },
];
