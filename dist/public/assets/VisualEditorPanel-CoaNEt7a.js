import{cT as ne,r as i,dg as U,bB as re,bC as oe,eb as E,e as ce,j as e,bX as F,cc as V,B as n,c as v,e6 as k,e7 as O,e8 as R,R as de,L as me,cx as pe,cj as he,cm as xe,bT as p,bU as P,cX as y,dj as ue,X as fe,fu as ge}from"./index-CjpUPH-S.js";import{S as T}from"./slider-Bjv-3_6_.js";import{S as ve}from"./switch-g9SPffuT.js";import{S as z}from"./smartphone-CyWM29NN.js";import{T as ye}from"./tablet-B8sxBSaw.js";import{M as D,e as we,f as je,h as Ne}from"./ReplitAgentPanelV3-CCFLaPc5.js";import{a as be,Z as Se}from"./zoom-out-BVduiWBY.js";import{U as Ce,R as Ee}from"./undo-2-CfZ516Xm.js";import{T as ke}from"./type-C2gbX12J.js";import{B as Oe}from"./bold-Bki_OuWq.js";import{I as Re}from"./italic-CRvqcM2b.js";import{S as Pe}from"./save-DqjLBY1Y.js";import"./textarea-B2tXYCnT.js";import"./brain-BgfDNi6k.js";import"./AIModelSelector-Bt1Nu-g9.js";import"./select--Y8W4ZJA.js";import"./chevron-up-CP9yJqbG.js";import"./skeleton-CumaPo6m.js";import"./index-Dlo-l9L0.js";import"./cpu-B_1rHIrR.js";import"./lightbulb-COSSCYjU.js";import"./LazyAgGrid-CnC9umbc.js";import"./table-CNsLhucb.js";import"./activity-j56EsLL3.js";import"./minimize-2-3_4y_nMF.js";import"./maximize-2-D7vCB9wo.js";import"./table-2-C62hflfR.js";import"./pause-pc6f4sk_.js";import"./test-tube-Dnuo9doy.js";import"./rotate-ccw-B9B3uYeo.js";import"./video-CbXFQeEx.js";import"./circle-play-ZblmbTUH.js";import"./external-link-CWZiG1kt.js";import"./volume-x-Bz9HEHvd.js";import"./volume-2-LxiVLe-I.js";import"./link-2-BKJcTS7q.js";import"./target-B6L-cDZi.js";import"./filter-B_57rD62.js";import"./command-CEe8a3cX.js";import"./file-plus-BFuMSN59.js";import"./timer-CFzVbplq.js";import"./minus-Kjzn3_R2.js";import"./square-pen-p8OqCrgY.js";import"./LightSyntaxHighlighter-DLucKWtH.js";import"./index-BCtPS2Zd.js";import"./use-reduced-motion-DD5VJU0y.js";import"./wand-sparkles-CytasEv8.js";import"./alert-dialog-_9S3zK7d.js";import"./mic-ZmAtDaur.js";import"./send-DpzkrXDD.js";const H=[{name:"Mobile S",width:320,height:568,icon:z},{name:"Mobile M",width:375,height:667,icon:z},{name:"Mobile L",width:425,height:812,icon:z},{name:"Tablet",width:768,height:1024,icon:ye},{name:"Laptop",width:1024,height:768,icon:U},{name:"Desktop",width:1440,height:900,icon:U}],X=["#000000","#1f2937","#374151","#6b7280","#9ca3af","#d1d5db","#ef4444","#f97316","#f59e0b","#eab308","#84cc16","#22c55e","#14b8a6","#06b6d4","#0ea5e9","#3b82f6","#6366f1","#8b5cf6","#a855f7","#d946ef","#ec4899","#f43f5e","#ffffff","transparent"];function kt({projectId:g,onCodeChange:w,className:$}){ne();const x=i.useRef(null),_=i.useRef(!1),[c,q]=i.useState(!1),[a,j]=i.useState(null),[N,Z]=i.useState(null),[r,b]=i.useState({}),[u,M]=i.useState(""),[m,G]=i.useState(H[5]),[f,L]=i.useState(100),[S,Q]=i.useState(!0),[Y,J]=i.useState([]),[K,ee]=i.useState([]),{data:d,isLoading:te,refetch:C}=re({queryKey:["/api/preview/url",g],queryFn:async()=>{const t=await fetch(`/api/preview/url?projectId=${g}`,{credentials:"include"});if(!t.ok)throw new Error("Failed to get preview status");return t.json()},enabled:!!g,refetchInterval:t=>{const s=t.state.data;return s?.status==="starting"?2e3:s?.status==="running"?1e4:!1}}),A=oe({mutationFn:async()=>ce("POST",`/api/preview/projects/${g}/preview/start`,{}),onSuccess:()=>{E({title:"Preview starting..."}),setTimeout(()=>C(),2e3)},onError:t=>{E({title:"Failed to start preview",description:t.message,variant:"destructive"})}});i.useEffect(()=>{d?.status==="stopped"&&!_.current&&(_.current=!0,A.mutate(void 0))},[d?.status]);const I=i.useCallback(()=>{const t=x.current;if(t?.contentWindow)try{const s=`
        (function() {
